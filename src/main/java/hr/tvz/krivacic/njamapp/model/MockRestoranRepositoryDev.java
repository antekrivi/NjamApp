...
@Profile("dev")
@Repository
public class MockRestoranRepositoryDev implements RestoranRepository{
    private final List<Restoran> restorani = Arrays.asList(
            new Restoran(1L, "DP", "Savska22", "123456", "rest1@gmail.com",
                    createRadnoVrijeme(), true, 30, 4.5, 10),
            new Restoran(2L, "GP", "Savska55", "654321", "rest2@gmail.com",
                    createRadnoVrijeme(), true, 25, 4.0, 15)
    );

    public MockRestoranRepositoryDev(){
